...
//
//     final chalanReturn = chalanReturnFromJson(jsonString);

import 'dart:convert';

ChalanReturn chalanReturnFromJson(String str) => ChalanReturn.fromJson(json.decode(str));

String chalanReturnToJson(ChalanReturn data) => json.encode(data.toJson());
...
class ChalanReturn {
  ...
  factory ChalanReturn.fromJson(Map<String, dynamic> json) => ChalanReturn(
    count: json["count"],
    next: json["next"],
