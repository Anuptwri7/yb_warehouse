...
class Result {
  ...
  factory Result.fromJson(Map<String, dynamic> json) => Result(
    ...
    supplierCountryName: json["supplier_country_name"] == null ? null : json["supplier_country_name"],
  ...
  Map<String, dynamic> toJson() => {
    ...
    "supplier_country_name": supplierCountryName == null ? null : supplierCountryName,
...
class PurchaseOrderDetail {
  ...
  factory PurchaseOrderDetail.fromJson(Map<String, dynamic> json) => PurchaseOrderDetail(
    id: json["id"],
    poPackTypeCodes: List<dynamic>.from(json["po_pack_type_codes"].map((x) => x)),
    itemName: json["item_name"],
    itemCode: json["item_code"],
    itemBasicInfo: json["item_basic_info"] == null ? null : json["item_basic_info"],
    itemCategoryName: json["item_category_name"],
    packingTypeName: json["packing_type_name"],
    packingTypeDetailItemUnitName: json["packing_type_detail_item_unit_name"] == null ? null : json["packing_type_detail_item_unit_name"],
    itemUnitShortForm: json["item_unit_short_form"] == null ? null : json["item_unit_short_form"],
    orderNo: json["order_no"],
  ...
  Map<String, dynamic> toJson() => {
    "id": id,
    "po_pack_type_codes": List<dynamic>.from(poPackTypeCodes.map((x) => x)),
    "item_name": itemName,
    "item_code": itemCode,
    "item_basic_info": itemBasicInfo == null ? null : itemBasicInfo,
    "item_category_name": itemCategoryName,
    "packing_type_name": packingTypeName,
    "packing_type_detail_item_unit_name": packingTypeDetailItemUnitName == null ? null : packingTypeDetailItemUnitName,
    "item_unit_short_form": itemUnitShortForm == null ? null : itemUnitShortForm,
    "order_no": orderNo,
    "expirable": expirable,
